...
Automatically translate your Figma Design Tokens (JSON) into strictly-typed, `@MainActor`-isolated Swift code. Zero-friction handoffs from designer to developer.

```swift
// Automatically generated by FigmaBridge
import SwiftUI
